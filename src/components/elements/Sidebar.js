...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div className="lg:w-64">
      ...
      >
        {/* Sidebar header */}
        <div className="flex justify-start items-center mb-10 pr-3 sm:px-2">
          {/* Close button */}
          <button
            ref={trigger}
          ...
          <span className="text-white font-medium ml-2 ">Data Manajemen</span>
        </div>
            ...
            >
              ...
              >
                <div className="flex flex-grow">
                  ...
                  <span className="text-sm font-medium">Data Budaya</span>
                </div>
              </button>
            </li>
            <li
            ...
            >
              ...
              >
                <div className="flex flex-grow">
                  ...
                  <span className="text-sm font-medium">Tambah BUdaya</span>
                </div>
              </button>
            </li>
            {/* Settings */}
